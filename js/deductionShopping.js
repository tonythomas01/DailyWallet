	...
	function deDuction()	{
		...
		var value =document.getElementById('stationary');
		var value1=document.getElementById('clothing');
		var value2=document.getElementById('accessories');
		var value3=document.getElementById('extra');
		...
		value.onclick=function(){
			...
			appendToStorage('stationary-',deductAmnt1);	
		}
		...
		value1.onclick=function()	{
			...
			appendToStorage('clothing-',deductAmnt1);	
		}
		...
		value2.onclick=function()	{
			...
			deductAmnt1=prompt('Amount Spend :','');
			if(checkOut(deductAmnt1)==1)	{
			appendToStorage('accessories-',deductAmnt1);	
		}
		...
		value3.onclick=function()	{
			...
			deductAmnt1=prompt('Amount Spend :','');
			if(checkOut(deductAmnt1)==1)	{
		appendToStorage('extra-',deductAmnt1);	
	}
		}
	}
