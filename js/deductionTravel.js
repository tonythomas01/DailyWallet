function deDuction()	{
		...
		var value =document.getElementById('bus');
		var value1=document.getElementById('auto');
		var value2=document.getElementById('train');
		...
		value.onclick=function(){
			...
			appendToStorage('bus-',deductAmnt1);	
		}
		...
		value1.onclick=function()	{
			...
			deductAmnt1=prompt('Amount Spend :','');
			if(checkOut(deductAmnt1))	{
			appendToStorage('auto-',deductAmnt1);
			}	
		...
		value2.onclick=function()	{
			...
			deductAmnt1=prompt('Amount Spend :','');
			if(checkOut(deductAmnt1))	{
			appendToStorage('train-',deductAmnt1);	
		}
